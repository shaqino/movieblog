...
<head>
	...
	<spring:url value="/resources/css/template-style.css"
		var="template-styleCss" />
	<spring:url value="/resources/owl-carousel/owl.carousel.css"
		var="owlCarouselCss" />
	<spring:url value="/resources/owl-carousel/owl.theme.css"
		var="owlThemeCss" />
				...
				<div class="top-nav">
					...
					<div class="top-nav s-12 l-5">
						<ul class="right top-ul chevron">
							...
							<li><a href="../design/product.html">Product</a></li>
							<li><a href="../design/services.html">Services</a></li>
						</ul>
					</div>
					<ul class="s-12 l-2">
						<li class="logo hide-s hide-m"><a href="../design/">DESIGN
								<br /> <strong>THEME</strong>
						</a></li>
					</ul>
					<div class="top-nav s-12 l-5">
						<ul class="top-ul chevron">
							<li><a href="../design/gallery.html">Gallery</a></li>
							<li><a>Company</a>
								<ul>
									<li><a>Company 1</a></li>
									<li><a>Company 2</a></li>
							...
							<li><a href="../design/contact.html">Contact</a></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<section>
				...
				<div class="item">
					...
					<div class="carousel-text">
						<div class="line">
							...
							<div class="s-12 l-9">
								<p>With amazing responsive carousel</p>
							</div>
						</div>
					</div>
				</div>
				<div class="item">
					...
					<div class="carousel-text">
						<div class="line">
							...
							<div class="s-12 l-9">
								<p>Lightweight, more intuitive and useful responsive CSS
									framework</p>
							</div>
						</div>
					</div>
				...
				<div class="item">
					...
					<div class="carousel-text">
						<div class="line">
							...
							<div class="s-12 l-9">
								<p>Best theme based on Responsee framework</p>
							</div>
						</div>
					</div>
				</div>
		...
		<div id="first-block">
			<div class="line">
				...
				<p class="subtitile">Lorem ipsum dolor sit amet, consectetuer
					adipiscing elit.</p>
				<div class="margin">
				...
				<div class="margin-bottom">
					<div class="margin">
						<article class="s-12 l-8 center">
							<h1>Amazing title</h1>
							<p class="margin-bottom">Lorem ipsum dolor sit amet,
								consectetuer adipiscing elit, sed diam nonummy nibh euismod
								tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi
								enim ad minim veniam, quis nostrud exerci tation ullamcorper
								suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>
							<a class="button s-12 l-4 center" href="product.html">Read
								more</a>
						</article>
					</div>
				</div>
			...
			<div class="s-12 l-6">
				<p class="right">
					<a class="right" href="http://www.myresponsee.com"
						...
						and coding by Responsee Team</a>
				</p>
			</div>
		</div>
	</footer>
